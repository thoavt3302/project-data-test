...
```
cd existing_repo
git remote add origin https://gitlab.com/vuthithoa3302/project-data-test1.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/vuthithoa3302/project-data-test1/-/settings/integrations)
